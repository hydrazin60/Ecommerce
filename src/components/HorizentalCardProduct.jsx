...
//               <div
//                 key={index}
//                 className="w-full md:min-w-[300px] min-w-[280px] md:max-w-[300px] max-w-[280px] h-36 bg-slate-500 rounded-md shadow-md flex animate-pulse"
//               ></div>
//             ))
//           : data.map((product, index) => (
//               <div
...
//                     </p>
//                   </div>
//                   <button className="bg-red-700 hover:bg-red-800 font-medium px-3 py-1 rounded-full text-white">
//                     Add to Cart
//                   </button>
//                 </div>
//               </div>
