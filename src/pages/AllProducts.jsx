...
//                 <div>
//                   <div
//                     className="w-9 h-9 p-2 bg-green-200 text-black text-xl hover:bg-green-700 rounded-full hover:text-white flex justify-center items-center cursor-pointer"
...
//                   alt="Product"
//                   className="object-cover mt-2 w-full h-48"
//                 />
